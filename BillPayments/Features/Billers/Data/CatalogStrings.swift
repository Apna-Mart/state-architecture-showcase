...
let providerPrefixes: [String: [String: String]] = [
...
let paramLabels: [String: [String: String]] = [
...
let paramHints: [String: [String: String]] = [
...
func enterHint(label: String, language: String) -> String {
    switch language {
    case "hi": return "\(label) दर्ज करें"
    case "ar": return "أدخل \(label)"
    default: return "Enter \(label)"
    }
}

func billerName(prefixId: String, categoryId: String, language: String) -> String {
    let prefix = providerPrefixes[prefixId]![language]!
    let category = categoryNames[categoryId]![language]!
